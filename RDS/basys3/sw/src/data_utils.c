...
int write_address(int fd, const uint8_t *address) {
    int ret;
    uint8_t ack;
    printf("writing_bytes in write_address\n");
    ...
    printf("reading_bytes in write_address\n");
...
int calibrate_sensor(int fd, uint8_t *plaintext, uint8_t *key,
    ...
    printf("Sensor trace collection success\n");
    int idc = 1;
    int idf = 0;
