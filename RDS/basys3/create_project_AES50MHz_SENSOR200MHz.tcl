...
# Import source files
import_files -norecurse "$src_path/hw/rtl/AES_Comp.v" \
			"$src_path/hw/rtl/read_traces.vhd" \
                        "$src_path/hw/rtl/sig_delay.vhd" \
                        "$src_path/hw/rtl/io_wrapper.vhd" \
                        "$src_path/hw/rtl/reset_wrapper.vhd" \
                        "$src_path/hw/rtl/xadc.vhd"  \
                        "$src_path/hw/rtl/system_top_artix7_fifo_aes.vhd" \
                        "$src_path/hw/rtl/packages/design_package.vhd" \
                        "$src_path/hw/rtl/general/BRAM_dual_clock.vhd" \
                        "$src_path/hw/rtl/general/counter_up.vhd" \
			"$src_path/hw/rtl/general/FSM_FIFO.vhd" \
                        "$src_path/hw/rtl/general/n_plus_k_div_ROM.coe" \
                        "$src_path/hw/rtl/general/n_plus_k_ROM.coe" \
                        "$src_path/hw/rtl/general/n_plus_k_div_ROM_k64.coe" \
                        "$src_path/hw/rtl/general/n_plus_k_ROM_k64.coe" \
                        "$src_path/hw/rtl/uart/UART.vhd" \
                        "$src_path/hw/rtl/uart/rxuartlite.v" \
                        "$src_path/hw/rtl/uart/txuartlite.v" \
                        "$src_path/hw/rtl/io_controller/address_dec.vhd" \
                        "$src_path/hw/rtl/io_controller/config_registers.vhd" \
                        "$src_path/hw/rtl/io_controller/data_dec.vhd" \
                        "$src_path/hw/rtl/io_controller/data_enc.vhd" \
                        "$src_path/hw/rtl/io_controller/io_fsm_fifo_aes.vhd" \
                        "$src_path/hw/rtl/io_controller/io_controller_fifo_aes.vhd" \
                        "$src_path/hw/rtl/sensor/sensor_top.vhd" \
                        "$src_path/hw/rtl/sensor/sensor.vhd"


update_compile_order -fileset sources_1
update_compile_order -fileset sources_1

import_files "$src_path/hw/ip/clock_generator/clock_generator.xci" \
             "$src_path/hw/ip/reset_gen/reset_gen.xci" \
             "$src_path/hw/ip/fifo_generator_0/fifo_generator_0.xci"
...
add_files -fileset constrs_1 -norecurse "$src_path/hw/xdc/constraints_RDS.xdc"
import_files -fileset constrs_1 "$src_path/hw/xdc/constraints_RDS.xdc"
